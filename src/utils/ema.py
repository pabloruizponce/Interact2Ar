...
class WeightAveraging(Callback):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize the averaged model wrapper.

        Args:
            device: Optional device where averaged weights are stored.
            use_buffers: Whether to average model buffers in addition to parameters.
            **kwargs: Extra arguments forwarded to PyTorch ``AveragedModel``.
        """
